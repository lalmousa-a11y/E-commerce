...
<aside class="w-64 bg-gray-900 text-white shadow-lg">
    ...
    <div class="p-6 border-b border-gray-700">
        ...
        <p class="text-gray-400 text-sm mt-1">E-Commerce Management</p>
    </div>
    ...
    <nav class="mt-6">
        ...
        <a href="{{ route('admin.dashboard') }}"
           class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white' : '' }}">
        ...
        <div class="mt-2">
            ...
            <div id="sellers-menu" class="hidden bg-gray-800">
                <a href="{{ route('sellers.index') }}"
                   class="block px-10 py-2 text-gray-400 hover:text-white text-sm {{ request()->routeIs('sellers.*') ? 'text-blue-400 bg-gray-700' : '' }}">
                    All Sellers
                </a>
            </div>
        </div>
        ...
        <div class="mt-2">
            ...
            <div id="products-menu" class="hidden bg-gray-800">
                <a href="{{ route('products.index') }}"
                   class="block px-10 py-2 text-gray-400 hover:text-white text-sm {{ request()->routeIs('products.*') ? 'text-blue-400 bg-gray-700' : '' }}">
                    All Products
                </a>
            </div>
        </div>
        ...
        <div class="mt-2">
            ...
            <div id="orders-menu" class="hidden bg-gray-800">
                <a href="{{ route('orders.index') }}"
                   class="block px-10 py-2 text-gray-400 hover:text-white text-sm {{ request()->routeIs('orders.*') ? 'text-blue-400 bg-gray-700' : '' }}">
                    All Orders
                </a>
            </div>
        </div>
